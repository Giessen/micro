...
//@ ^D Duplicate Line
var keydisplay = []string{"^X Quit, ^S Save, ^O Open, ^T New Tab,  F5/6 CMD/SH, ^G/D Goto/Del Line, ^K/C|J Cut/Copy, ^/ Comment",
                          "^F Find, ^Z Undo, ^Y Redo, ^A Mark All, ^E Mark,     ^I Find Text,       ^V|U Paste"}
